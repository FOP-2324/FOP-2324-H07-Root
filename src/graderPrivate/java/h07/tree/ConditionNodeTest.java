...
public class ConditionNodeTest extends H07Test {
    ...
    public void testConstructor(String input) throws Throwable {
        ...
        //Node
        Object toTest = CONDITION_NODE_CONSTRUCTOR.invoke(CONDITION_NODE.getLink().reflection(), null, objectiveNode, trueNode, falseNode);
        ...
        boolean actual = CONDITION_EXPRESSION_CHECK.invoke(CONDITION_EXPRESSION.getLink().reflection(), FieldReference.CONDITION_NODE_CONDITION_EXPRESSION.getLink().get(toTest), input);
    ...
    public void  testSetConditionExpression() throws Throwable {
        ...
        CONDITION_NODE_SET_CONDITION_EXPRESSION.invoke(CONDITION_NODE.getLink().reflection(), toTest, conditionExpression);

        FieldReference.CONDITION_NODE_CONDITION_EXPRESSION.assertStoredValue(toTest, conditionExpression, emptyContext());
    }
    ...
    public void testEvaluate(JsonParameterSet params) throws Throwable {
        ...
        when(CONDITION_EXPRESSION_CHECK.invoke(CONDITION_NODE.getLink().reflection(), conditionExpression, anyString())).thenReturn(expected);
